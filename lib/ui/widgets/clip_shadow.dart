  ...
  void paint(Canvas canvas, Size size) {
    clipShadow.forEach((BoxShadow shadow) {
      ...
      var clipPath = clipper
          .getClip(spreadSize)
          .shift(Offset(shadow.offset.dx - shadow.spreadRadius, shadow.offset.dy - shadow.spreadRadius));
...
class ClipShadow extends StatelessWidget {
  ...
  ClipShadow({required this.boxShadow, required this.clipper, required this.child});
