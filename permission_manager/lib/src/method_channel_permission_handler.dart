...
/// An implementation of [PermissionManagerPlatform] that uses [MethodChannel]s.
class MethodChannelPermissionHandler extends PermissionManagerPlatform {
  /// Checks the current status of the given [Permission].
  static const MethodChannel _methodChannel = MethodChannel('com.elaunch.permissions');

  @override
  Future<PermissionStatus> checkPermissionStatus(Permission permission) async {
    final status = await _methodChannel.invokeMethod('checkPermissionStatus', permission.value);
  ...
  Future<ServiceStatus> checkServiceStatus(Permission permission) async {
    final status = await _methodChannel.invokeMethod('checkServiceStatus', permission.value);
  ...
  Future<bool> openAppSettings() async {
    return _methodChannel.invokeMethod('openAppSettings').then((value) => value ?? false);
  }
  ...
  Future<Map<Permission, PermissionStatus>> requestPermissions(List<Permission> permissions) async {
    ...
    final status = await _methodChannel.invokeMethod('requestPermissions', data);
  ...
  Future<bool> shouldShowRequestPermissionRationale(Permission permission) async {
    return _methodChannel
        .invokeMethod('shouldShowRequestPermissionRationale', permission.value)
