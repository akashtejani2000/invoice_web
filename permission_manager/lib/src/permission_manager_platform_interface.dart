...
/// added [PermissionManagerPlatform] methods.
abstract class PermissionManagerPlatform extends PlatformInterface {
  ...
  static PermissionManagerPlatform _instance = MethodChannelPermissionHandler();
  ...
  /// [PermissionManagerPlatform] when they register themselves.
  ...
  Future<bool> shouldShowRequestPermissionRationale(Permission permission) {
    throw UnimplementedError('shouldShowRequestPermissionRationale() has not been implemented.');
  }
}
